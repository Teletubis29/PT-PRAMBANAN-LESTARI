			...
			<div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center gap-8 md:gap-16">
				...
				<div className="flex-1 text-white">
					...
					<ul className="space-y-2 mb-4 text-base md:text-lg text-gray-100">
						<li>Kami telah mengelola lebih dari 80 properti di berbagai lokasi strategis.</li>
						<li>+80 pelanggan telah melakukan pembelian dan puas dengan layanan kami.</li>
						<li>+30 mitra telah mempercayakan proyek mereka kepada kami.</li>
