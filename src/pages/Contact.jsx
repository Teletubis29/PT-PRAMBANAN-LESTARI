  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.status === 200) {
        setStatusMessage('Pesan berhasil dikirim! Kami akan menghubungi Anda segera.');
      ...
      if (error.text) {
        ...
        errorMessage = 'Konfigurasi EmailJS tidak valid. Silakan periksa Service ID, Template ID, dan Public Key.';
      }
